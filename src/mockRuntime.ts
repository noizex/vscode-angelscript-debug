...
// https://github.com/rubyide/vscode-ruby/blob/master/src/debugger/interface.ts

// https://www.angelcode.com/angelscript/sdk/docs/manual/doc_debug.html#doc_debug_4
...
export class MockRuntime extends EventEmitter {
	...
	constructor() {
		super();
		this._client.on('error', (error: Error) => { console.log(error) });

		this._client.connect(55557, '127.0.0.1', () => {
